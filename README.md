...
```bash
git init
git remote add origin https://github.com/dimani001/HNG_Stage1.git
git branch -M main
git config user.name "dimani001"
git config user.email "chidimma516@gmail.com"
...
- **Base URL**: `https://hng-dimani-stage1.onrender.com`
- **Example Endpoint**:
    - Successful Response: `https://hng-dimani-stage1.onrender.com/api/classify-number?number=371`
    - Error Response: `https://hng-dimani-stage1.onrender.com/api/classify-number?number=abc`
...
1. Tested with valid numbers:
    - `https://hng-dimani-stage1.onrender.com/api/classify-number?number=371`
2. Tested with invalid inputs:
    - `https://hng-dimani-stage1.onrender.com/api/classify-number?number=abc`
3. Tested edge cases:
    - Negative numbers
    - Large integers
    - Zero
...
- **Email**: [chidimma516@gmail.com](mailto:chidimma516@gmail.com)
